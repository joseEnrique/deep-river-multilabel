"""
Búsqueda exhaustiva de hiperparámetros para LSTM con Rolling Window.
...
# Configuraciones a probar - ENFOQUE EN WINDOW SIZE Y LEARNING RATE PARA LSTM
configs = [
    # ============================================================================
...
for i, config in enumerate(configs, 1):
    ...
    try:
        ...
        if i % 5 == 0:
            ...
            df_temp.to_csv(f'lstm_window_search_partial_{timestamp}.csv', index=False)
...
timestamp = datetime.now().strftime('%Y%m%d_%H%M%S')
csv_filename = f'lstm_window_search_results_{timestamp}.csv'
